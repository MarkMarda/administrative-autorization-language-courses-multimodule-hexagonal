...
public class SurveyException extends DomainException {
    /**
     ...
     * @since 1.7
     */
    protected SurveyException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
